...
bi_lstm_model = tf.keras.models.load_model('new_bidirectional_lstm_model_01.h5')
tfidf = joblib.load('tfidf_transformer_01.pkl')
...
def index():
    ...
    return render_template('suraj.html', result=None, error=None)
...
def scan():
    ...
    if not text:
        ...
        return render_template('suraj.html', result=None, error=error)
    ...
    return render_template('suraj.html', result=result, error=None)
